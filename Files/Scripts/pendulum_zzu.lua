...
for i = 1, n_bones do
  ...
  pJoint(j, b, bpname, bname, spheres[1].center, nil, nil, min_extents, max_extents )
end
...
pJoint(j, b, "leg a " .. n_bones, "foot", sphere_foot.center, nil, nil, min_extents, max_extents)
